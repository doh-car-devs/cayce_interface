<div class="card card-success">
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <small class="form-text text-muted mb-2">
                    NOTE: Only approved WFP by <b>Division Chief</b> will be shown in the list above.
                    <a href="{{route('wfp.index')}}" class="text-primary">Click here to view your section WFP</a>
                </small>
            </div>
        </div>
                    ...
                    <div class="col-md-7">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mb-3 single-basic" id="ppmp_mop" name="ppmp_mop" required="required">
                                        <option disabled value="" selected hidden>Please Select...</option>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label for="ppmp_qty">Quantity <small> (Please Fill out Milestones to add quantity)</small></label>
                                    <div class="input-group">
                                        @include('_interface.snip.inputPrepend')
                                        <input class="form-control" id="ppmp_qty" type="number" name="ppmp_qty" value="" min="0" required="required" onfocus="blur();">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="row">
                                @foreach ($data['months'] as $key => $value)
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control milestoneclass" type="number" id="milestones{{$key+1}}" name="milestones{{$key+1}}" value="0" min="0" required>
                                    </div>
                                    @endif
                                @endforeach
                            </div>
    ...
    <div class="card-footer">
        <button type="submit" class="btn btn-primary float-right btn-block">Save PPMP Entry</button>
    </div>
</div>
