<table id="trustfundbudgettable" class="table table-bordered table-sm table-hover">
    <thead class="thead-dark">
        <tr>
            ...
            <th colspan="3" class="text-center">Trust Funds</th>
            <th rowspan="2" class="text-right" style="width: 10%">Take Action</th>
        </tr>
        <tr>
            <th>Trust Funds Allocation Status<small>(Trust Funds)</small></th>
            <th>Allocated</th>
            <th>Unallocated</th>
        </tr>
    </thead>
    <tbody class="annualbudgetbody">
        @foreach ($data['annual'] as $item)
            @if ($item['parent_type_abbr'] == 'Trust Funds')
            <tr>
