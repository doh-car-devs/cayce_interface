...
@section('content')
		...
		<div class="col">
			<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
				...
				<li class="nav-item btn-group ml-auto">
                    {{-- <a class="btn btn-secondary mb-1 mr-3 btn-lg " data-toggle="modal" data-target="#edit2" id="deliverable-make-tab" data-toggle="pill" href="#deliverable-make" role="tab" aria-controls="deliverable-make" aria-selected="false"><i class="fas fa-plus-square mr-1"></i>Add NEW Deliverable</a>
    ...
    {{-- @if ($errors->isEmpty()) --}}
        @include('_wfp.tables.consolidated')
	    ...
	    {{-- @include('_wfp.tables.consolidatedWFP') --}}
    {{-- @endif --}}
