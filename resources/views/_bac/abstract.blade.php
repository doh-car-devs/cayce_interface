...
@section('content')
		...
		<div class="col">
			<ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
				...
				<li class="nav-item mr-3">
					...
					{{-- <a class="btn btn-primary mb-1 " id="custom-content-above-home2-tab" data-toggle="pill" href="#custom-content-above-home2" role="tab" aria-controls="custom-content-above-home2" aria-selected="true"><i class="fas fa-table mr-1"></i>Abstract Of Bids</a> --}}
				</li>
				<li class="nav-item btn-group ml-auto">
                    ...
                    {{-- <a class="btn btn-primary mb-1" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true"><i class="fas fa-table mr-1"></i>Public Bidding</a>
                    <a class="btn btn-primary mb-1" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true"><i class="fas fa-table mr-1"></i>Direct Contracting</a>
                    <a class="btn btn-primary mb-1" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true"><i class="fas fa-table mr-1"></i>Repeat Order</a>
                    <a class="btn btn-primary mb-1" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true"><i class="fas fa-table mr-1"></i>Shopping</a>
                    <a class="btn btn-primary mb-1" id="custom-content-above-home-tab" data-toggle="pill" href="#custom-content-above-home" role="tab" aria-controls="custom-content-above-home" aria-selected="true"><i class="fas fa-table mr-1"></i>Negotiated Procurement</a> --}}
	...
	<div class="tab-content" id="custom-content-above-tabContent">
        ...
        {{-- <div class="tab-pane fade" id="custom-content-above-home2" role="tabpanel" aria-labelledby="custom-content-above-home-tab">
            @include('_interface.cards.wideCard',
